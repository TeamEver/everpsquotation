            ...
            <table style="width: 100%" height="10">
                <tr>
                    <td valign="left" style="font-weight: bold; font-size: 5pt; width: 100%; text-align: left;">
                        <br /><br /><br /><br />
                        <strong style="font-size: 14pt; font-weight: normal; line-height: 2pt">DEVIS : {$reference|escape:'htmlall':'UTF-8'}</strong><br />
                        <strong style="font-size: 10pt; font-weight: normal;">Nom : {$first_name|escape:'htmlall':'UTF-8'} {$last_name|escape:'htmlall':'UTF-8'}</strong><br />
